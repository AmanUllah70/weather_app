    ...
    return GlowContainer(
      ...
      child: Column(
        children: [
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text(
                      " 7 days", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold),
                    )
                  ],
                ),
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          GlowText(tomorrowTemp.max.toString(),
                    ...
                    Text(" " + tomorrowTemp.name, style: TextStyle(fontSize: 15,),
                    )
                  ],
                )
              ],
          ...
          Padding(padding: EdgeInsets.only(bottom: 20, right: 50, left: 50),
            child: Column(
              children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 15),
                          Text(sevenDay[index].name, style: TextStyle(fontSize: 20),)
                        ],
                      ),
                    ),
                    Row(
                      children: [
                        Text("+" + sevenDay[index].max.toString() + "\u00B0", style: TextStyle(fontSize: 20),),

                        SizedBox(width: 5,),

                        Text("+" + sevenDay[index].min.toString() + "\u00B0", style: TextStyle(fontSize: 20, color: Colors.grey),),
                      ],
                    )
                  ],
                ));
